...
- we split the pacakge into these three packages to make it easier to maintain and develop the pacakge in the future. The core `shapiq` package will require the most maintenance and development care, so we want the project to be as focused as possible.
