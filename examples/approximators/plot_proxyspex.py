...
Proxy-based SPEX approximation using
:class:`~shapiq.ProxySPEX` :footcite:t:`Butler.2025`.
"""
...
approximator = shapiq.ProxySPEX(n=N_PLAYERS, max_order=2, random_state=42)
