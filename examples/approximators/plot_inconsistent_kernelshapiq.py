...
Faster variant of KernelSHAPIQ that does not converge to true SII, using
...
approximator = shapiq.InconsistentKernelSHAPIQ(n=N_PLAYERS, max_order=2, random_state=42)
