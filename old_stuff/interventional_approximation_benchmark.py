...
if __name__ == "__main__":
    ...
    N_BACKGROUND_SAMPLES = (
        10  # number of background samples for the interventional feature perturbation
    )
    ...
    def explain_instance(args):
        ...
        budget_range = np.linspace(
            min(500, 2**game.n_players / 10),
            min(2**game.n_players, MAX_BUDGET),
            N_BUDGET_STEPS,
        ).astype(int)
