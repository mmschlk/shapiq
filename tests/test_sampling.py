"""This test module contains all tests regarding the sampling class"""
from copy import copy, deepcopy

import numpy as np
import pytest
from games import DummyGame
import CoalitionSampler


@pytest.mark.parametrize(
    "n, sampling_weights, border_trick, pairing_trick, random_state",
    [
        (10, np.ones(11), False),
        (10, np.ones(11), True),
        (10,np.ones(11)-2,True), #expected to fail
        (10,np.ones(10),False) #expected to fail
    ],
)
def test_initialization(n, sampling_weights, pairing_trick):
    """Tests the initialization of the CoalitionSampler."""
