...
def test_adult():
    ...
    assert game.game_name == "AdultCensus(RandomForestEnsembleSelection)"
...
def test_california():
    ...
    assert values[0] == 0.0  # should be zero
    assert values[1] != 0.0  # should not be zero
    assert game.game_name == "CaliforniaHousing(RandomForestEnsembleSelection)"
...
def test_bike():
    ...
    assert values[0] == 0.0  # should be zero
    assert values[1] != 0.0  # should not be zero
    assert game.game_name == "BikeSharing(RandomForestEnsembleSelection)"
