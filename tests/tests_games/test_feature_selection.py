...
def test_california(model_name):
    ...
    assert len(value) == 1
    assert game.game_name == "CaliforniaHousing(FeatureSelection)"
...
def test_adult_census(model_name):
    ...
    assert game.n_players == n_players
    assert len(value) == 1
    assert game.game_name == "AdultCensus(FeatureSelection)"
...
def test_bike_sharing(model_name):
    ...
    assert game.n_players == n_players
    assert len(value) == 1
    assert game.game_name == "BikeSharing(FeatureSelection)"
