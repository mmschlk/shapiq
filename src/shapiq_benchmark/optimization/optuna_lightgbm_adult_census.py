"""Optimize LightGBM hyperparameters for Adult Census classification."""
...
def main() -> None:
    """Run Optuna optimization for LightGBM on Adult Census."""
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("results/lightgbm_adult_census.json"),
    )
