...
from shapiq_games.benchmark.dataset_valuation.base import DatasetValuation
...
class CaliforniaHousing(DatasetValuation):
    ...
    Examples:
        >>> import numpy as np
        >>> from shapiq_games.benchmark.dataset_valuation import CaliforniaHousing
        ...
        >>> from shapiq.game import Game  # for loading the game via its values
...
class BikeSharing(DatasetValuation):
    ...
    Examples:
        >>> import numpy as np
        >>> from shapiq_games.benchmark.dataset_valuation import BikeSharing
...
class AdultCensus(DatasetValuation):
    ...
    Examples:
        >>> import numpy as np
        >>> from shapiq_games.benchmark.dataset_valuation import AdultCensus
