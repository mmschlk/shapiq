...
from shapiq_games.benchmark.global_xai.base import GlobalExplanation
...
class AdultCensus(GlobalExplanation):
    ...
    For more information, see :class:`~shapiq_games.benchmark.global_xai.base.GlobalExplanation`.
    """
        ...
        *,
        ...
        Args:
            ...
            loss_function: The loss function to use for the model. Defaults to
                ...
                :class:`~shapiq_games.benchmark.setup.GameBenchmarkSetup` class.
