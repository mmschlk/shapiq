...
from shapiq_games.benchmark.ensemble_selection.base import RandomForestEnsembleSelection
        ...
        *,
        ...
        Args:
            loss_function: The loss function to use for the ensemble selection game. Defaults to
                ``'accuracy_score'``. See :class:`~shapiq_games.benchmark.setup.GameBenchmarkSetup`
...
class BikeSharing(RandomForestEnsembleSelection):
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            loss_function: The loss function to use for the ensemble selection game. Defaults to
                ``'r2_score'``. See :class:`~shapiq_games.benchmark.setup.GameBenchmarkSetup` for
