...
from .local_xai.benchmark_language import LMGeneration as LMGenerationLocalXAI
from .local_xai.benchmark_tabular import (
    ...
    Bioresponse as BioresponseLocalXAI,
    BreastCancer as BreastCancerLocalXAI,
    CaliforniaHousing as CaliforniaHousingLocalXAI,
    Chess as ChessLocalXAI,
    CommunitiesAndCrime as CommunitiesAndCrimeLocalXAI,
    Condind as CondindLocalXAI,
    Corrgroups60 as Corrgroups60LocalXAI,
    Cross as CrossLocalXAI,
    Disjunct as DisjunctLocalXAI,
    ForestFires as ForestFiresLocalXAI,
    Group as GroupLocalXAI,
    Hepatitis as HepatitisLocalXAI,
    Independent as IndependentLinear60LocalXAI,
    Ionosphere as IonosphereLocalXAI,
    Leukemia as LeukemiaLocalXAI,
    Microresponse as MicroresponseLocalXAI,
    Mushroom as MushroomLocalXAI,
    Nhanesi as NHANESILocalXAI,
    Nursery as NurseryLocalXAI,
    RealEstate as RealEstateLocalXAI,
    Soybean as SoybeanLocalXAI,
    Sphere as SphereLocalXAI,
    Thyroid as ThyroidLocalXAI,
    WineQuality as WineQualityLocalXAI,
    Xor as XorLocalXAI,
    Zoo as ZooLocalXAI,
)
...
message = "This collection of games is deprecated and will be removed in a future version."
