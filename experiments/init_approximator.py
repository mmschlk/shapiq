...
def get_approximators(APPROXIMATORS,n_players,RANDOM_STATE,PAIRING,REPLACEMENT):
    ...
    if "ShapleyGAX-2ADD" in APPROXIMATORS:
        ...
        shapley_gax_kadd = ShapleyGAX(n=n_players, explanation_basis=kadd, random_state=RANDOM_STATE, sampling_weights=kernelshap_weights,pairing_trick=PAIRING,replacement=REPLACEMENT)
