...
if __name__ == "__main__":
    ...
    N_BACKGROUND_SAMPLES = 10 # number of background samples for the interventional feature perturbation
    ...
    # Compute the ground truth values for the games
        for game in GAMES:
            ...
            for id_explain in ID_EXPLANATIONS:
                ...
                background_data = game.setup.x_train[:N_BACKGROUND_SAMPLES,:]
                ...
                save_path = "ground_truth/interventional/" + game_id + "_" + str(RANDOM_STATE) + "_" + str(id_explain) + "_exact_values.json"
    ...
    def explain_instance(args):
        ...
        for approximator in approximators:
            ...
            for budget in budget_range:
                ...
                save_path = "approximations/interventional/" + game_id + "_" + str(ID_CONFIG_APPROXIMATORS) + "_" + str(
