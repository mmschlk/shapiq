    ...
    # Compute the ground truth values for the games
        for game in GAMES:
            ...
            for id_explain in ID_EXPLANATIONS:
                ...
                save_path = "ground_truth/pathdependent/" + game_id + "_" + str(RANDOM_STATE) + "_" + str(id_explain) + "_exact_values.json"
        ...
        for approximator in approximators:
            ...
            for budget in budget_range:
                try:
                    ...
                    save_path = "approximations/pathdependent/" + game_id + "_" + str(ID_CONFIG_APPROXIMATORS) + "_" + str(
